...
)
{
	...
	// Calculate the position of this vertex projected onto the display
	{
		...
		// direct projection to world for UI
		o_vertexPosition_projected = vertexPosition_world; //mul( g_transform_cameraToProjected, vertexPosition_camera );
	}
	// pass the color
	{
...
void main()
{
	...
	// Calculate the position of this vertex projected onto the display
	{
		...
		// Project the vertex from camera space into projected space
		//g_transform_cameraToProjected * vertexPosition_camera;
